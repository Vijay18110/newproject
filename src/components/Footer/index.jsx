...
const Footer = () => {
    return <div className={styles.footercont}>
        <div>
        ...
        <div>
            <p>
                <div className={styles.mid}>
                    <p> <span> <FaPhoneVolume size={30} color="#7e7e7e" /></span> 1900 - 6666</p>
                    <p> Working 8:00 - 22:00</p>
                </div>
                <div className={styles.mid}>
                    <p><span> <FaPhoneVolume size={30} color="#7e7e7e" /></span> 1900 - 8888</p>
